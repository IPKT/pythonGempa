...
def ambilDataGempaIndoM5 (no):
    # baca disini bro https://nanonets.com/blog/parse-xml-files-using-python/
    url_lama = 'https://data.bmkg.go.id/DataMKG/TEWS/autogempa.xml'
    ...
    infoGempa = 'Info Gempa Mag:'+magnitude+" SR, " + tanggal +" "+ jam +", Lok:"+lintang+","+bujur+" ("+wilayah+"), Kedlmn:"+kedalaman
...
def prosesDataGempaIndoM5(id,infoGempa, lat,lon):
